...
# toxicity simple 
mod01 <- lm_robust(Toxicity ~ intervention, data = data_total)
# toxicity adjusted
...
mod03 <- lm_robust(comment_length ~ intervention, data = data_total)
...
# toxicity simple 
mod11 <- lm_robust(Toxicity ~ intervention, data = data_disagree)
# toxicity adjusted
mod12 <- lm_robust(Toxicity ~ intervention  + gender + education + topic + post_direction + UserLanguage  +
                    issue_attitudes_2 + issue_attitudes_3  + social_media +  comments_online +  angry_views + attitude_distance ,
                  data = data_disagree)
# comment length simple
mod13 <- lm_robust(comment_length ~ intervention, data = data_disagree)
# comment length adjusted
...
# toxicity simple 
mod21 <- lm_robust(Toxicity ~ intervention, data = data_manipulation)
# toxicity adjusted
mod22 <- lm_robust(Toxicity ~ intervention  + gender + education + topic + post_direction + UserLanguage  +
                    issue_attitudes_2 + issue_attitudes_3  + social_media +  comments_online +  angry_views + attitude_distance ,
                  data = data_manipulation)
# comment length simple
mod23 <- lm_robust(comment_length ~ intervention, data = data_manipulation)
# comment length adjusted
...
# toxicity simple 
mod31 <- lm_robust(Toxicity ~ intervention, data = data_disagree_manipulation)
# toxicity adjusted
mod32 <- lm_robust(Toxicity ~ intervention  + gender + education + topic + post_direction + UserLanguage  +
                    issue_attitudes_2 + issue_attitudes_3  + social_media +  comments_online +  angry_views + attitude_distance ,
                  data = data_disagree_manipulation)
# comment length simple
mod33 <- lm_robust(comment_length ~ intervention, data = data_disagree_manipulation)
# comment length adjusted
...
# toxicity simple 
mod41 <- lm_robust(Toxicity ~ intervention, data = data_pap)
# toxicity adjusted
mod42 <- lm_robust(Toxicity ~ intervention  + gender + education + topic + post_direction + UserLanguage  +
                    issue_attitudes_2 + issue_attitudes_3  + social_media +  comments_online +  angry_views + attitude_distance ,
                  data = data_pap)
# comment length simple
mod43 <- lm_robust(comment_length ~ intervention, data = data_pap)
# comment length adjusted
...
source("code/3-coefficient-plots-manipulation.R")

# primary hypotheses
cp1
ggsave("output/cp1_manipulation.pdf", cp1, width = 14, height = 14) 

cp1s
ggsave("output/cp1_manipulation_simple.pdf", cp1s, width = 10, height = 7) 

# secondary hypotheses
cp2
ggsave("output/cp2_manipulation.pdf", cp2, width = 8) 
